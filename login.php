...
//         header('Location: app/');
//     } 
//site key: 6Lcoum0iAAAAALN1D2SxBhfKYH3aBaeY-82LHC6O
//secret key: 6Lcoum0iAAAAAPiw0sXyy9XIPiSVE5IxFQBfkAcw
    ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="card card-outline card-red">
                ...
                <div class="card-body">
                    ...
                    <div class=" text-center mb-5">
                        <a href="index" class="h1 text-dark" style="text-decoration: none;"><b>Inventory </b>System</a>
                    </div>
                    <form action="conf/verify.php" method="post" autocomplete="off">
                        ...
                        <div class="input-group mb-3">
                            <button type="submit" name="login" class="btn btn-warning btn-lg btn-block">
